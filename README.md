...
| **pipeline efficiency tracking** | table of past runs from neo4j: scenes, corrections, warnings, totals + per-stage split when **Token Agent** is **v1+** (**v0** = legacy: **N/A** for E/F/A columns). phase log: **`Telemetry.md`**. |
